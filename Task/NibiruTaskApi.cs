...
namespace NibiruTask
{
    ...
    public class NibiruTaskApi
    {
        ...
        public static void OpenFileManager(string path)
        {
            ...
            // AndroidJavaObject task = GetNibiruTask(TASK_ACTION.OPEN_FILE);
            // AddNibiruTaskParameter(task,File.FILE_KEY_OPEN_FILE,"false");
            RunOnUIThread(androidActivity,()=>
            {
                nibiruOsServiceObject.Call("openFileManager",path); 
            });
        }
        ...
        public static void SetWifiEnable(bool enable)
        {
            ...
            if (nibiruOsServiceObject != null)
            {
                RunOnUIThread(androidActivity, () =>
                {
                    nibiruOsServiceObject.Call("setWifiEnable", enable); 
                });
            }
        }
        ...
        public static bool IsWifiEnabled()
        {
            ...
            if (nibiruOsServiceObject != null)
            {
                return nibiruOsServiceObject.Call<bool>("isWifiEnabled");
            }
        ...
        public static void SetBluetoothEnable(bool enable)
        {
            ...
            if (nibiruOsServiceObject != null)
            {
                RunOnUIThread(androidActivity,(() =>
                {
                    nibiruOsServiceObject.Call("setBluetoothEnable", enable);
                }));
            }
        }
        ...
        public static bool IsBluetoothEnabled()
        {
            ...
            if (nibiruOsServiceObject != null)
            {
                return nibiruOsServiceObject.Call<bool>("isBluetoothEnabled");
            }
        ...
        public static void InstallApk(string apkPath)
        {
            ...
            if (nibiruOsServiceObject != null)
            {
                nibiruOsServiceObject.Call("installApk", apkPath, new NibiruApkInstallListener());
            }
        }
        ...
        public static void UninstallApk(string packageName)
        {
            ...
            if (nibiruOsServiceObject != null)
            {
                nibiruOsServiceObject.Call("uninstallApk", packageName, new NibiruApkInstallListener());
            }
        }
        ...
        public static void InstallAndStartApk(string apkPath)
        {
            ...
            if (nibiruOsServiceObject != null)
            {
                nibiruOsServiceObject.Call("installAndStartApk", apkPath);
            }
        }
    ...
    public class NibiruApkInstallListener : AndroidJavaProxy
    {
        public NibiruApkInstallListener() : base("com.nibiru.service.NibiruOSService$INibiruApkInstallListener")
        {
        }
        ...
        public void onInstallSuccess(string filePath, string packageName)
        {
            ...
            if (NibiruTaskApi.InstallSuccessEvent != null)
            {
                NibiruTaskApi.InstallSuccessEvent(filePath, packageName);
            }
        }
        ...
        public void onInstallFailed(string filePath, string packageName)
        {
            ...
            if (NibiruTaskApi.InstallFailedEvent != null)
            {
                NibiruTaskApi.InstallFailedEvent(filePath, packageName);
            }
        }
        ...
        public void onUninstallFailed(string packageName)
        {
            ...
            if (NibiruTaskApi.UninstallFailedEvent != null)
            {
                NibiruTaskApi.UninstallFailedEvent(packageName);
            }
        }
        ...
        public void onUninstallSuccess(string packageName)
        {
            ...
            if (NibiruTaskApi.UninstallSuccessEvent != null)
            {
                NibiruTaskApi.UninstallSuccessEvent(packageName);
            }
        }
    }
}
