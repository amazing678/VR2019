...
namespace Nxr.Internal
{
    public class AndroidDevice : NxrDevice
    {
        ...
        {
            string result = "0";
            CallStaticMethod<string>(ref result, nibiruVR, "getSystemProperty", "persist.nsr.sysui.enable", "0");
        ...
        {
            CallStaticMethod(nibiruVR, "setSystemProperty", "persist.nsr.sysui.enable", "" +enableSystemDialog); 
        }
    }
}
/// @endcond
